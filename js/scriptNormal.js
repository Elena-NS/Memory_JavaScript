...
for (let i = 0; i < 18; i++) {
    document.getElementsByTagName("img")[i].onclick = function () {
        ...
        if (parejas < 9 && document.getElementsByTagName("img")[i].classList.length < 3) {
            ...
            if (seleccionadas[0] != seleccionadas[1]) {
                if (abiertos == 0) {
                    ...
                    if (p1 == p2) {
                        abiertos = 0;
                        parejas++;
                        document.getElementsByClassName(p1)[0].style.background = "rgba(59, 59, 59, 0.733)";
                        document.getElementsByClassName(p1)[0].classList.add("emparejada");
                        document.getElementsByClassName(p1)[1].style.background = "rgba(59, 59, 59, 0.733)";
                        ...
                        if (parejas == 9) {
                            setTimeout(() => {
                                alert("¡Enhorabuena! Has completado el memory nivel normal.");
                            }, 200)
                        }
                    } else {
                        setTimeout(() => {
                            abiertos = 0;
                            document.getElementsByClassName(p1)[0].src = "img/logo2.png";
                            document.getElementsByClassName(p1)[1].src = "img/logo2.png";
                            document.getElementsByClassName(p2)[0].src = "img/logo2.png";
                            document.getElementsByClassName(p2)[1].src = "img/logo2.png";
                        }, 1000);
                    }
